...
const routes = {
  ...
  "GET /api/messages/:id/receipt": ({ params, session }) => ok(services.messageReceipt(params.id, { actor: session?.email ?? "system" })),
  "POST /api/messages/:id/read": ({ params, body, session }) => ok(services.readMessage(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/messages/:id/acknowledge": ({ params, body, session }) => ok(services.acknowledgeMessage(params.id, { ...body, actor: requestActor(session, body) })),
  ...
  "GET /api/reports/:id/official-packet": ({ params, session }) => ok(services.officialReportPacket(params.id, { actor: session?.email ?? "system" })),
  "POST /api/reports/:id/official-packet/export": ({ params, body, session }) => ok(services.exportReportPacket(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/reports/:id/official-packet/archive": ({ params, body, session }) => createdResponse(services.archiveReportPacket(params.id, { ...body, actor: requestActor(session, body) })),
  ...
  "POST /api/chat/rooms": ({ body, session }) => createdResponse(services.createChatRoom({ ...body, actor: requestActor(session, body) })),
  "POST /api/chat/rooms/:id/messages": ({ params, body, session }) => createdResponse(services.sendChatMessage(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/chat/presence": ({ body, session }) => ok(services.updateChatPresence({ ...body, actor: requestActor(session, body) })),
  "POST /api/chat/rooms/:id/read": ({ params, body, session }) => ok(services.markChatRoomRead(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/chat/messages/:id/pin": ({ params, body, session }) => ok(services.pinChatMessage(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/chat/rooms/:id/archive": ({ params, body, session }) => ok(services.archiveChatRoom(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/chat/rooms/:id/task": ({ params, body, session }) => createdResponse(services.createChatTask(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/chat/rooms/:id/meeting": async ({ params, body, session }) => createdResponse(await services.startChatMeeting(params.id, { ...body, actor: requestActor(session, body) })),
  "POST /api/chat/rooms/:id/churchmail": async ({ params, body, session }) => createdResponse(await services.escalateChatToChurchMail(params.id, { ...body, actor: requestActor(session, body) })),
